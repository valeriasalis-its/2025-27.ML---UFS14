...
- I modelli girano senza nessun problema su CPU; addestrare Optuna su GPU *potrebbe* causare saturazione della VRAM [docs/decisioni/0008](docs/decisioni/0008-optuna-xgboost-cpu.md).
